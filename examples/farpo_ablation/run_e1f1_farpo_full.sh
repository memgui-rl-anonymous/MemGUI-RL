#!/usr/bin/env bash
# FARPO ablation cell E1F1: full FARPO: reward-decoupled estimator + folding-aware sampling (rho = 9).
...
EXPERIMENT_NAME=qwen3_vl_8b_farpo_ablation_e1f1_farpo_full_seed1
