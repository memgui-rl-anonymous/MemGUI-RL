#!/usr/bin/env bash
# FARPO ablation cell E0F0: GRPO recipe: aggregate-then-normalise estimator, natural (size-matched) sampling.
...
EXPERIMENT_NAME=qwen3_vl_8b_farpo_ablation_e0f0_scalar_natural_seed1
