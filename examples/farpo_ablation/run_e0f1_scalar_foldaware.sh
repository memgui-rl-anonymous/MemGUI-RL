#!/usr/bin/env bash
# FARPO ablation cell E0F1: aggregate-then-normalise estimator with folding-aware sampling (rho = 9).
...
EXPERIMENT_NAME=qwen3_vl_8b_farpo_ablation_e0f1_scalar_foldaware_seed1
