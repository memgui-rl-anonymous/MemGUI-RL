...
class SequentialFunctionRewardManagerMixin:
    ...
    def compute_reward_sequential(self, data: DataProto) -> Tuple[torch.Tensor, dict[str, list[float]]]:
        ...
        for i in range(len(data)):
            ...
            # forward extra metadata (e.g. step_number) to the reward function
            if "step_number" in data.non_tensor_batch:
                reward_input["step_number"] = data.non_tensor_batch["step_number"][i]
